...
| Persistent system navigation | isolated Settings route at wide and narrow viewports plus Back/Forward automation | **Passed 2026-09-01:** Collection, Transfers, and Settings remain keyboard-reachable in the persistent header; the active destination exposes `aria-current=page`; Collection returns directly from Settings without requiring history, while Back and Forward restore both destinations |
