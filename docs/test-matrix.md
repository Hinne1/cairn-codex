...
| First-run onboarding persistence | isolated pure-decision/preference-store gate plus wide and narrow fresh-profile screenshot fixtures | Passed 2026-09-01: discovery, Item Assistant/continue-without-import choice, explicit preservation of the existing archive, stashes, saves, and Item Assistant data, archive/live and SC/HC model, focus containment/restoration, skip/resume, version reset, and Settings reopen behavior are covered without reading or writing real game data |
