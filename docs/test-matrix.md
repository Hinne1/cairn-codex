...
| Cross-workspace visual acceptance audit | source-build app, isolated generated 24,553-copy profile, 24 wide/narrow captures, 11 filter-empty runs, and DOM overflow/count instrumentation | **Baseline recorded 2026-09-01 under #58:** all 12 requested destinations were asserted before capture; every searchable workspace rendered a zero-result state; Collection mounted 48/5,525 cards, Skill Explorer 50/61 rows, Planner 44/44 rows, MI Workshop 50/1,774 rows, Oracle 12/3,148 cards, Dismantling 120/24,509 candidates, and Transfers 50/24,609 operations. Sets mounted all 202 cards and Farming all 214 route cards, now owned by #64/#65; remaining manual card caps are #68. The focused shell and narrow overflow findings were resolved by #62/#63 and their dedicated gates above. Full keyboard/assistive-technology acceptance remains #16. |
