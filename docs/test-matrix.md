...
| Product naming copy policy | deterministic renderer-visible source scan plus isolated onboarding, Settings, Transfers, and workspace-recovery captures at 1280×900 and 520×900 | **Passed 2026-09-01:** formal product contexts retain Cairn Codex; application actions and ownership use CC; the only standalone Cairn uses are 11 exact lore/content allowances; all eight representative layouts remain readable without clipping |
