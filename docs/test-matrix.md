...
| Sets rarity and readiness semantics | unit gate plus isolated synthetic wide/narrow Electron fixtures | **Passed 2026-09-01:** Epic and Legendary cards use shared rarity tokens; discovered completion excludes recipe and awakening qualifications; storage, recipe, awakening, missing, level, completion, and FX badges remain explicit at 1,440 px and 760 px; `craftable:true OR awakening:true` matched the single qualified set in 154.2 ms including its 150 ms debounce |
