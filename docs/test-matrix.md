...
| Shared structured search | parser unit gate, desktop SQL smoke, and cached 24,514-copy profile | **Passed 2026-09-01:** implicit/explicit Boolean operators, grouping, phrases, negation, aliases, Unicode text, booleans, and numeric comparisons share one parser; invalid edits show an inline error without emptying the view; a `source:"item assistant" AND mode:hardcore AND seed:>=3100000000` history query matched 10,000 operations in 153.5 ms including its 150 ms debounce and rendered 50 rows |
