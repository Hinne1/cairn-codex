...
| Transfer operation histories | isolated desktop journal smoke plus cached 24,514-copy profile | **Passed 2026-09-01:** ingestion and retrieval are queried from the durable operation journal in 50-row pages; a 20,090-result journal search took 155.4 ms including its 150 ms debounce and rendered exactly 50 operation rows; record, seed, SC/HC mode, outcome, timestamps, source, errors, and correlation IDs survive the IPC boundary; Retrieve, both histories, and Quarantine are separate Back/Forward-restorable views |
