...
| First-run onboarding persistence | isolated preference-store unit gate plus fresh-profile screenshot fixture | Passed 2026-09-01: discovery, Item Assistant/start-empty choice, archive/live and SC/HC model, safety guidance, skip/resume, version reset, and Settings reopen behavior are covered without reading real saves |
