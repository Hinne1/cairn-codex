...
| Leveling Planner creation and navigation | setup/migration unit gates plus isolated packaged 1,440 px and 520 px Electron fixtures | **Passed 2026-09-01:** Blank, character-save, and clone starting points share a four-step focus-contained dialog; combined masteries, complete indexed skill suggestions, and level windows persist without changing legacy plans; the compact toolbar remains aligned at both widths; Back/Forward restores the active plan after creation |
