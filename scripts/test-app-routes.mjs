...
assert.match(appSource, /inspectionSession\.restore\(route\.itemRecord, referenceInstanceKey\)/)
...
assert.match(appSource, /setsSession\.restoreRoute\(route\.controls\)/)
...
assert.match(appSource, /controls: setsSession\.routeControls\.value/)
