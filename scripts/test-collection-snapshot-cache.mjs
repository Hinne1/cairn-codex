...
try {
  ...
  assert.deepEqual(await readCollectionSnapshotCache(path, presentationVersion), snapshot)
  ...
  assert.deepEqual(
    await readCollectionSnapshotCache(path, presentationVersion),
    snapshot,
  ...
  assert.equal(await readCollectionSnapshotCache(path, presentationVersion), null)
