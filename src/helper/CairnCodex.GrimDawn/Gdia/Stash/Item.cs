...
namespace IAGrim.Parser.Stash {
    public class Item : IComparable<Item> {
        ...
        public bool Read(GDCryptoDataBuffer pCrypto) {
            ...
            if (this.Version >= 8u) {
                flag = !pCrypto.ReadCryptoString(out this.BaseRecord) || !pCrypto.ReadCryptoString(out this.PrefixRecord)
                                                                           ...
                                                                           || (this.Version >= 11u && !pCrypto.ReadCryptoUInt(out this.AffixRerolls));
            }
            else {
                flag = !pCrypto.ReadCryptoString(out this.BaseRecord) || !pCrypto.ReadCryptoString(out this.PrefixRecord)
                                                                           || !pCrypto.ReadCryptoString(out this.SuffixRecord) || !pCrypto.ReadCryptoString(out this.ModifierRecord)
        ...
        public void Write(DataBuffer pBuffer) {
            ...
            if (this.Version >= 11u)
            {
                pBuffer.WriteUInt(this.AffixRerolls);
            }
        ...
        public override bool Equals(Object? obj) {
            ...
            if (!Equals(this.Rerolls, that.Rerolls)) return false;
            if (!Equals(this.AffixRerolls, that.AffixRerolls)) return false;
        ...
        public override int GetHashCode() {
            ...
            hashCode = hashCode * -1521134295 + Rerolls.GetHashCode();
            hashCode = hashCode * -1521134295 + AffixRerolls.GetHashCode();
            return hashCode;
        }
    }
}
